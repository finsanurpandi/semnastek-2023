...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Upload Manuscript Terbaru #{{$article->id}}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('author.manuscript.store.revised')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
